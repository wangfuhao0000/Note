...
protected Object createProxy(
   ...
   for (Advisor advisor : advisors) {
      proxyFactory.addAdvisor(advisor);  //添加到工厂中
   }
   ...
   return proxyFactory.getProxy(getProxyClassLoader());  //工厂进行创建
}
```
